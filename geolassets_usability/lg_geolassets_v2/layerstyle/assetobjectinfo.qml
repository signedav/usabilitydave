...
<qgis styleCategories="AllStyleCategories" version="3.25.0-Master" maxScale="0" minScale="1e+08" hasScaleBasedVisibilityFlag="0" readOnly="0">
  ...
  <referencedLayers>
    <relation referencingLayer="AssetObjectInfo_8e159f5d_d144_41d8_ae22_009ed05561e3" providerKey="ogr" id="assetobjectinfo_T_basket_T_ILI2DB_BASKET_T_Id" layerId="T_ILI2DB_BASKET_24d5e8f0_9bd3_4c3c_a60d_4ffe4cc4876c" dataSource="./lg_geolAssets_v2_data.gpkg|layername=T_ILI2DB_BASKET" referencedLayer="T_ILI2DB_BASKET_24d5e8f0_9bd3_4c3c_a60d_4ffe4cc4876c" layerName="T_ILI2DB_BASKET" name="assetobjectinfo_T_basket_T_ILI2DB_BASKET_T_Id" strength="Association">
      <fieldRef referencedField="T_Id" referencingField="T_basket"/>
    </relation>
    <relation referencingLayer="AssetObjectInfo_8e159f5d_d144_41d8_ae22_009ed05561e3" providerKey="ogr" id="assetobjectinfo_lg_glssts_vssts_ssttem_assetobjectinfo_lg_geolssts_v2geolassets_assetitem_T_Id" layerId="AssetItem_655d7d08_f608_4aef_b23f_9bfc2ff514b1" dataSource="./lg_geolAssets_v2_data.gpkg|layername=lg_geolssts_v2geolassets_assetitem" referencedLayer="AssetItem_655d7d08_f608_4aef_b23f_9bfc2ff514b1" layerName="AssetItem" name="assetobjectinfo_lg_glssts_vssts_ssttem_assetobjectinfo_lg_geolssts_v2geolassets_assetitem_T_Id" strength="Association">
      <fieldRef referencedField="T_Id" referencingField="lg_glssts_vssts_ssttem_assetobjectinfo"/>
    </relation>
    <relation referencingLayer="AssetObjectInfo_8e159f5d_d144_41d8_ae22_009ed05561e3" providerKey="ogr" id="assetobjectinfo_objectclass_autoobjectcatitem_T_Id" layerId="AutoObjectCatItem_75539524_b4b4_497a_8a57_d0a91ab375d5" dataSource="./lg_geolAssets_v2_data.gpkg|layername=autoobjectcatitem" referencedLayer="AutoObjectCatItem_75539524_b4b4_497a_8a57_d0a91ab375d5" layerName="AutoObjectCatItem" name="assetobjectinfo_objectclass_autoobjectcatitem_T_Id" strength="Association">
      <fieldRef referencedField="T_Id" referencingField="objectclass"/>
    </relation>
  </referencedLayers>
  <fieldConfiguration>
  ...
  <defaults>
    ...
    <default expression="" field="objectclass" applyOnUpdate="0"/>
    <default expression="" field="objectpage" applyOnUpdate="0"/>
    <default expression="" field="objectbbox" applyOnUpdate="0"/>
    <default expression="" field="objectscore" applyOnUpdate="0"/>
    <default expression="" field="pathtoimage" applyOnUpdate="0"/>
    <default expression="" field="lg_glssts_vssts_ssttem_assetobjectinfo" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" field="objectclass" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="objectpage" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint unique_strength="0" field="objectbbox" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="objectscore" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="pathtoimage" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint unique_strength="0" field="lg_glssts_vssts_ssttem_assetobjectinfo" exp_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="objectclass" width="-1" hidden="0"/>
      <column type="field" name="objectpage" width="-1" hidden="0"/>
      <column type="field" name="objectbbox" width="-1" hidden="0"/>
      <column type="field" name="objectscore" width="-1" hidden="0"/>
      <column type="field" name="pathtoimage" width="-1" hidden="0"/>
      <column type="field" name="lg_glssts_vssts_ssttem_assetobjectinfo" width="-1" hidden="0"/>
