...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorField name="objectclass" showLabel="1" index="4"/>
    <attributeEditorField name="objectpage" showLabel="1" index="5"/>
    <attributeEditorField name="objectbbox" showLabel="1" index="6"/>
    <attributeEditorField name="objectscore" showLabel="1" index="7"/>
    <attributeEditorField name="pathtoimage" showLabel="1" index="8"/>
  </attributeEditorForm>
  <editable>
