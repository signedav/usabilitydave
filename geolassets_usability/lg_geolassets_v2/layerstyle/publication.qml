...
<qgis styleCategories="AllStyleCategories" version="3.25.0-Master" maxScale="0" minScale="1e+08" hasScaleBasedVisibilityFlag="0" readOnly="0">
  ...
  <referencedLayers>
    <relation referencingLayer="Publication_8b5be96a_a6ef_4328_8264_b8b55874fb0b" providerKey="ogr" id="publication_T_basket_T_ILI2DB_BASKET_T_Id" layerId="T_ILI2DB_BASKET_24d5e8f0_9bd3_4c3c_a60d_4ffe4cc4876c" dataSource="./lg_geolAssets_v2_data.gpkg|layername=T_ILI2DB_BASKET" referencedLayer="T_ILI2DB_BASKET_24d5e8f0_9bd3_4c3c_a60d_4ffe4cc4876c" layerName="T_ILI2DB_BASKET" name="publication_T_basket_T_ILI2DB_BASKET_T_Id" strength="Association">
      <fieldRef referencedField="T_Id" referencingField="T_basket"/>
    </relation>
    <relation referencingLayer="Publication_8b5be96a_a6ef_4328_8264_b8b55874fb0b" providerKey="ogr" id="publication_achannel_pubchannelitem_T_Id" layerId="PubChannelItem_1c7184c4_18a8_4c91_aeef_4155e3c133cd" dataSource="./lg_geolAssets_v2_data.gpkg|layername=pubchannelitem" referencedLayer="PubChannelItem_1c7184c4_18a8_4c91_aeef_4155e3c133cd" layerName="PubChannelItem" name="publication_achannel_pubchannelitem_T_Id" strength="Association">
      <fieldRef referencedField="T_Id" referencingField="achannel"/>
    </relation>
  </referencedLayers>
  <fieldConfiguration>
  ...
  <defaults>
    ...
    <default expression="" field="datepublication" applyOnUpdate="0"/>
    <default expression="" field="achannel" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="datepublication" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint unique_strength="0" field="achannel" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint unique_strength="0" field="adescription" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="link" exp_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="T_Id" exp="" desc=""/>
    <constraint field="T_basket" exp="" desc=""/>
    <constraint field="T_Ili_Tid" exp="" desc=""/>
    <constraint field="datepublication" exp="" desc=""/>
    <constraint field="achannel" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="datepublication" width="-1" hidden="0"/>
      <column type="field" name="achannel" width="-1" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorField showLabel="1" index="3" name="datepublication"/>
    <attributeEditorField showLabel="1" index="4" name="achannel"/>
    <attributeEditorField showLabel="1" index="5" name="adescription"/>
    <attributeEditorField showLabel="1" index="6" name="link"/>
  </attributeEditorForm>
  <editable>
