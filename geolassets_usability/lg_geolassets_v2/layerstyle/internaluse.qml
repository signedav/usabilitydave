...
<qgis version="3.25.0-Master" readOnly="0" styleCategories="LayerConfiguration|Forms">
  ...
  <fieldConfiguration>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="internaluse_T_basket_T_ILI2DB_BASKET_T_Id" name="Relation"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="ogr" name="ReferencedLayerProviderKey"/>
            <Option type="QString" value="internaluse_astatus_statusassetuseitem_T_Id" name="Relation"/>
            <Option type="bool" value="false" name="ShowForm"/>
            <Option type="bool" value="false" name="ShowOpenFormButton"/>
          </Option>
        </config>
    ...
    <field name="lg_glssts_vssts_ssttem_internaluse">
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="ogr" name="ReferencedLayerProviderKey"/>
            <Option type="QString" value="internaluse_lg_glssts_vssts_ssttem_internaluse_lg_geolssts_v2geolassets_assetitem_T_Id" name="Relation"/>
            <Option type="bool" value="false" name="ShowForm"/>
            <Option type="bool" value="false" name="ShowOpenFormButton"/>
          </Option>
        </config>
