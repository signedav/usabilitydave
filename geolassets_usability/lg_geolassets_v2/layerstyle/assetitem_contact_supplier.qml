...
<qgis maxScale="0" readOnly="0" styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Temporal|Legend|Elevation|Notes" version="3.22.6-Białowieża" minScale="1e+08" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="Relation" value="assetitem_contact_supplier_T_basket_T_ILI2DB_BASKET_T_Id" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerProviderKey" value="ogr" type="QString"/>
            <Option name="Relation" value="assetitem_contact_supplier_suppliedassetitem_assetitem_assetitem_T_Id" type="QString"/>
            <Option name="ShowForm" value="false" type="bool"/>
            <Option name="ShowOpenFormButton" value="false" type="bool"/>
          </Option>
        </config>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerName" value="AssetItem" type="QString"/>
            <Option name="ReferencedLayerProviderKey" value="ogr" type="QString"/>
            <Option name="Relation" value="assetitem_contact_supplier_suppliedassetitem_lg_geolssts_v2geolassets_assetitem_lg_geolssts_v2geolassets_assetitem_T_Id" type="QString"/>
            <Option name="ShowForm" value="false" type="bool"/>
            <Option name="ShowOpenFormButton" value="false" type="bool"/>
          </Option>
        </config>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="AllowNULL" value="true" type="bool"/>
            <Option name="OrderByValue" value="true" type="bool"/>
            <Option name="Relation" value="assetitem_contact_supplier_supplier_contact_contact_T_Id" type="QString"/>
            <Option name="ShowForm" value="false" type="bool"/>
            <Option name="ShowOpenFormButton" value="false" type="bool"/>
          </Option>
        </config>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerProviderKey" value="ogr" type="QString"/>
            <Option name="Relation" value="assetitem_contact_supplier_supplier_lg_geolssts_v2geolassets_contact_lg_geolssts_v2geolassets_contact_T_Id" type="QString"/>
            <Option name="ShowForm" value="false" type="bool"/>
            <Option name="ShowOpenFormButton" value="false" type="bool"/>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias name="SuppliedAssetItem" field="suppliedassetitem_assetitem" index="2"/>
    <alias name="SuppliedAssetItem LG" field="suppliedassetitem_lg_geolssts_v2geolassets_assetitem" index="3"/>
    <alias name="Supplier" field="supplier_contact" index="4"/>
    <alias name="Supplier  LG" field="supplier_lg_geolssts_v2geolassets_contact" index="5"/>
  </aliases>
  <defaults>
    ...
    <default field="suppliedassetitem_assetitem" applyOnUpdate="0" expression=""/>
    <default field="suppliedassetitem_lg_geolssts_v2geolassets_assetitem" applyOnUpdate="0" expression=""/>
    <default field="supplier_contact" applyOnUpdate="0" expression=""/>
    <default field="supplier_lg_geolssts_v2geolassets_contact" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" field="suppliedassetitem_assetitem" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="suppliedassetitem_lg_geolssts_v2geolassets_assetitem" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="supplier_contact" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="supplier_lg_geolssts_v2geolassets_contact" notnull_strength="0" unique_strength="0" exp_strength="0"/>
  </constraints>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="T_basket" hidden="0" width="280" type="field"/>
      <column name="suppliedassetitem_assetitem" hidden="0" width="209" type="field"/>
      <column name="suppliedassetitem_lg_geolssts_v2geolassets_assetitem" hidden="0" width="246" type="field"/>
      <column name="supplier_contact" hidden="0" width="-1" type="field"/>
      <column name="supplier_lg_geolssts_v2geolassets_contact" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField name="suppliedassetitem_assetitem" index="2" showLabel="1"/>
    <attributeEditorField name="suppliedassetitem_lg_geolssts_v2geolassets_assetitem" index="3" showLabel="1"/>
    <attributeEditorField name="supplier_contact" index="4" showLabel="1"/>
    <attributeEditorField name="supplier_lg_geolssts_v2geolassets_contact" index="5" showLabel="1"/>
  </attributeEditorForm>
  <editable>
    <field name="T_Id" editable="1"/>
    <field name="T_basket" editable="1"/>
    <field name="suppliedassetitem_assetitem" editable="1"/>
    <field name="suppliedassetitem_lg_geolssts_v2geolassets_assetitem" editable="1"/>
