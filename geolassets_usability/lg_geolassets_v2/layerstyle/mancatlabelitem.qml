      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option value="/home/dave/qgis_project/lg_geolAssets_v2_4/lg_geolAssets_v2_data.gpkg|layername=T_ILI2DB_BASKET" type="QString" name="ReferencedLayerDataSource"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorHtmlElement name="Dummy to create empty form" showLabel="0"></attributeEditorHtmlElement>
  </attributeEditorForm>
  <editable>
