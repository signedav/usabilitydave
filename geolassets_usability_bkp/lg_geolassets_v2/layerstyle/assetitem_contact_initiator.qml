...
<qgis maxScale="0" readOnly="0" styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Temporal|Legend|Elevation|Notes" version="3.22.6-Białowieża" minScale="1e+08" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="Relation" value="assetitem_contact_initiator_T_basket_T_ILI2DB_BASKET_T_Id" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="AllowNULL" value="true" type="bool"/>
            <Option name="OrderByValue" value="true" type="bool"/>
            <Option name="Relation" value="assetitem_contact_initiator_initiatedassetitem_assetitem_assetitem_T_Id" type="QString"/>
            <Option name="ShowForm" value="false" type="bool"/>
            <Option name="ShowOpenFormButton" value="false" type="bool"/>
          </Option>
        </config>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerProviderKey" value="ogr" type="QString"/>
            <Option name="Relation" value="assetitem_contact_initiator_initiatedassetitem_lg_geolssts_v2geolassets_assetitem_lg_geolssts_v2geolassets_assetitem_T_Id" type="QString"/>
            <Option name="ShowForm" value="false" type="bool"/>
            <Option name="ShowOpenFormButton" value="false" type="bool"/>
          </Option>
        </config>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="AllowNULL" value="true" type="bool"/>
            <Option name="OrderByValue" value="true" type="bool"/>
            <Option name="Relation" value="assetitem_contact_initiator_initiator_contact_contact_T_Id" type="QString"/>
            <Option name="ShowForm" value="false" type="bool"/>
            <Option name="ShowOpenFormButton" value="false" type="bool"/>
          </Option>
        </config>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerProviderKey" value="ogr" type="QString"/>
            <Option name="Relation" value="assetitem_contact_initiator_initiator_lg_geolssts_v2geolassets_contact_lg_geolssts_v2geolassets_contact_T_Id" type="QString"/>
            <Option name="ShowForm" value="false" type="bool"/>
            <Option name="ShowOpenFormButton" value="false" type="bool"/>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias name="InitiatedAssetItem" field="initiatedassetitem_assetitem" index="2"/>
    <alias name="InitiatedAssetItem  LG" field="initiatedassetitem_lg_geolssts_v2geolassets_assetitem" index="3"/>
    <alias name="Initiator" field="initiator_contact" index="4"/>
    <alias name="Initiator  LG" field="initiator_lg_geolssts_v2geolassets_contact" index="5"/>
  </aliases>
  <defaults>
    ...
    <default field="initiatedassetitem_assetitem" applyOnUpdate="0" expression=""/>
    <default field="initiatedassetitem_lg_geolssts_v2geolassets_assetitem" applyOnUpdate="0" expression=""/>
    <default field="initiator_contact" applyOnUpdate="0" expression=""/>
    <default field="initiator_lg_geolssts_v2geolassets_contact" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" field="initiatedassetitem_assetitem" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="initiatedassetitem_lg_geolssts_v2geolassets_assetitem" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="initiator_contact" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="initiator_lg_geolssts_v2geolassets_contact" notnull_strength="0" unique_strength="0" exp_strength="0"/>
  </constraints>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="initiatedassetitem_assetitem" hidden="0" width="-1" type="field"/>
      <column name="initiatedassetitem_lg_geolssts_v2geolassets_assetitem" hidden="0" width="-1" type="field"/>
      <column name="initiator_contact" hidden="0" width="-1" type="field"/>
      <column name="initiator_lg_geolssts_v2geolassets_contact" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField name="initiatedassetitem_assetitem" index="2" showLabel="1"/>
    <attributeEditorField name="initiatedassetitem_lg_geolssts_v2geolassets_assetitem" index="3" showLabel="1"/>
    <attributeEditorField name="initiator_contact" index="4" showLabel="1"/>
    <attributeEditorField name="initiator_lg_geolssts_v2geolassets_contact" index="5" showLabel="1"/>
  </attributeEditorForm>
  <editable>
    <field name="T_Id" editable="1"/>
    <field name="T_basket" editable="1"/>
    <field name="initiatedassetitem_assetitem" editable="1"/>
    <field name="initiatedassetitem_lg_geolssts_v2geolassets_assetitem" editable="1"/>
